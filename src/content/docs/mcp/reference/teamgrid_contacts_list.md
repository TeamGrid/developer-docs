...
- [`listContacts`](/api/v1/reference/operations/listcontacts/) — `GET /contacts`
...
> List the first 20 TeamGrid contacts. Do not request another page; tell me whether another cursor is available.
