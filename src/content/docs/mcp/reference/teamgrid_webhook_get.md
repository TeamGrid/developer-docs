---
title: teamgrid_webhook_get
description: "Get one TeamGrid webhook without exposing its signing secret."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_webhook_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getWebhook`](/api/v1/reference/operations/getwebhook/) — `GET /webhooks/{id}`
...
> Read the TeamGrid webhook with ID `<id>` and summarize only the fields returned by TeamGrid.
