...
`teamgrid_products_list` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
> List the first 20 TeamGrid products. Do not request another page; tell me whether another cursor is available.
