---
title: teamgrid_task_recurrence_versions_list
description: "List immutable definition versions for one TeamGrid task recurrence."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_task_recurrence_versions_list` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`listTaskRecurrenceVersions`](/api/v1/reference/operations/listtaskrecurrenceversions/) — `GET /task-recurrences/{id}/versions`
...
> List the first 20 TeamGrid task recurrence versions. Do not request another page; tell me whether another cursor is available.
