---
title: teamgrid_services_list
description: "List TeamGrid services."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_services_list` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`listServices`](/api/v1/reference/operations/listservices/) — `GET /services`
...
**commercial-data:** Service responses can contain commercially sensitive billing configuration.
...
> List the first 20 TeamGrid services. Do not request another page; tell me whether another cursor is available.
...
| The credential lacks `services:read` or cannot access the requested resource. | The tool returns `teamgrid_request_failed`; the redacted detail comes from the rejected TeamGrid request. |
