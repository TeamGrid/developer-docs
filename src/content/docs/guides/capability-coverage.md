...
| --- | ---: | --- |
| Released in the release-candidate contract | 49 | A bounded public v1 workflow is implemented across its required surfaces |
| Partial | 7 | Some useful behavior exists, but the product workflow is not yet complete |
...
classification applies to credentials, custom-field values, project templates,
