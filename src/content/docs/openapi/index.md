...
The stable `1.0.0` manifest records 130 v1 paths, 208 governed v1 operations, 87 frozen v0
...
checkpoint is `1.0.3`. See [resource concurrency](/api/v1/resource-concurrency/).
