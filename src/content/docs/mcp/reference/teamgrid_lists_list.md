---
title: teamgrid_lists_list
description: "List TeamGrid task lists."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_lists_list` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`listLists`](/api/v1/reference/operations/listlists/) — `GET /lists`
...
> List the first 20 TeamGrid lists. Do not request another page; tell me whether another cursor is available.
