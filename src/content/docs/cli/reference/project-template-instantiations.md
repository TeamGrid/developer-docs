...
description: "1 executable @teamgrid/cli commands in the project-template-instantiations group, generated from CLI 1.0.7."
...
- [`teamgrid project-template-instantiations get`](#teamgrid-project-template-instantiations-get) — Get a project-template instantiation operation.

## teamgrid project-template-instantiations get
...
```bash
teamgrid project-template-instantiations get [options] <id>
```
...
| --- | --- | --- | --- |
| `getProjectTemplateInstantiation` | `GET /project-template-instantiations/{id}` | `project-templates:write` | [Get a project-template instantiation operation](/api/v1/reference/operations/getprojecttemplateinstantiation/) |
...
```bash
teamgrid project-template-instantiations get ID
```
