...
- [`getTaskRecurrenceOccurrence`](/api/v1/reference/operations/gettaskrecurrenceoccurrence/) — `GET /task-recurrences/{id}/occurrences/{occurrenceKey}`
...
> List the first 20 TeamGrid task recurrence occurrence. Do not request another page; tell me whether another cursor is available.
