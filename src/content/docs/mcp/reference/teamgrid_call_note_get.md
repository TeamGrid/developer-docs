---
title: teamgrid_call_note_get
description: "Get one TeamGrid call note. The result can contain conversation data."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_call_note_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getCallNote`](/api/v1/reference/operations/getcallnote/) — `GET /call-notes/{id}`
...
> Read the TeamGrid call note with ID `<id>` and summarize only the fields returned by TeamGrid.
