---
title: teamgrid_service_get
description: "Get one TeamGrid service and its potentially sensitive billing rate."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_service_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getService`](/api/v1/reference/operations/getservice/) — `GET /services/{id}`
...
> Read the TeamGrid service with ID `<id>` and summarize only the fields returned by TeamGrid.
