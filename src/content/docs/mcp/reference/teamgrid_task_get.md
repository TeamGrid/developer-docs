---
title: teamgrid_task_get
description: "Get one TeamGrid task by id."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_task_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getTask`](/api/v1/reference/operations/gettask/) — `GET /tasks/{id}`
...
> Read the TeamGrid task with ID `<id>` and summarize only the fields returned by TeamGrid.
