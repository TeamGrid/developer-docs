...
- [`listTaskRecurrences`](/api/v1/reference/operations/listtaskrecurrences/) — `GET /task-recurrences`
...
> List the first 20 TeamGrid task recurrences. Do not request another page; tell me whether another cursor is available.
