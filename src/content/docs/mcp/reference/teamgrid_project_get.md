---
title: teamgrid_project_get
description: "Get one TeamGrid project by id."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_project_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getProject`](/api/v1/reference/operations/getproject/) — `GET /projects/{id}`
...
> Read the TeamGrid project with ID `<id>` and summarize only the fields returned by TeamGrid.
