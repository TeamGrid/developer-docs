---
title: teamgrid_contact_group_get
description: "Get one TeamGrid contact group by id."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_contact_group_get` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`getContactGroup`](/api/v1/reference/operations/getcontactgroup/) — `GET /contact-groups/{id}`
...
> Read the TeamGrid contact group with ID `<id>` and summarize only the fields returned by TeamGrid.
