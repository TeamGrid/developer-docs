---
title: teamgrid_task_recurrence_occurrences_list
description: "List the immutable occurrence ledger for one TeamGrid task recurrence with stable cursor pagination."
owner: Developer Platform
reviewedAt: 2026-08-10
---

`teamgrid_task_recurrence_occurrences_list` is a read-only, idempotent TeamGrid MCP tool. It is introduced by the
...
- [`listTaskRecurrenceOccurrences`](/api/v1/reference/operations/listtaskrecurrenceoccurrences/) — `GET /task-recurrences/{id}/occurrences`
...
> List the first 20 TeamGrid task recurrence occurrences. Do not request another page; tell me whether another cursor is available.
